...
public abstract class Task implements IHttpParameters, IHttpHeaders {
     ...
     * OSS地址
     */
    public static String OSS_END_POINT = "oss-cn-beijing.aliyuncs.com";
     ...
     * {@link com.aliyun.android.oss.OSSException}抛出
     * 
     * @return 服务器返回的响应对象
     ...
     * 
     * @param response
     * @return 返回{@link HttpResponseError}对象，由{@link com.aliyun.android.oss.xmlparser.HttpResponseErrorParser}
     *         解析后获得
