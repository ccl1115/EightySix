...
public class GetObjectTask extends Task {
    ...
    /**
     * 获取文件传输的范围，用{@link com.aliyun.android.oss.model.Range}对象表示
     * 
     * @return 返回文件传输的范围
     * @see com.aliyun.android.oss.model.Range
     */
    ...
    /**
     * 设置文件传输范围，用{@link com.aliyun.android.oss.model.Range}对象表示
     * 
     * @param range
     *            文件传输范围
     * @see com.aliyun.android.oss.model.Range
     ...
     * 获取对象，包括对象元信息以及对象内容 
     * 
     * @return {@link com.aliyun.android.oss.model.OSSObject}对象，包含对象元信息以及内容
     * @throws Exception
