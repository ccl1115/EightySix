...
public class CopyObjectTask extends Task {
    ...
    public CopyObjectTask(String srcBucket, String srcObj, String destBucket,
        ...
        this.destBucketName = destBucket;
    ...
    protected void checkArguments() {
        ...
        if (Helper.isEmptyString(destBucketName)
    ...
    /**
     * 如果值为<code>{@link com.aliyun.android.oss.task.CopyObjectTask.MetaDirective.COPY}</code>，则新的Object的Meta信息都从源Object复制过来<br/>
     * 如果值为<code>{@link com.aliyun.android.oss.task.CopyObjectTask.MetaDirective.REPLACE}</code>，则忽视所有源Object的Meta值，而采用用户这次请求中指定的meta值
     * 
     * @param directive
     * @see com.aliyun.android.oss.task.CopyObjectTask.MetaDirective
     */
    ...
    /* @throws OSSException
     * @see com.aliyun.android.oss.model.OSSObject
     */
    public OSSObject getResult() throws OSSException {
        try {
            ...
            OSSObject obj = new OSSObject(this.destBucketName, this.destObjectKey);
