 ...
 * 用户需要将创建该Object Group所需的Object Name,E-tag以及标识该Object在整个Group中相对位置
 * 的Part ID按照规定的XML格式发给OSS
 * 
 * @author Harttle
 */
public class PostObjectGroupTask extends Task {
    ...
    /**
     * 获取Post操作后得到的结果，返回一个{@link com.aliyun.android.oss.model.OSSObjectSummary}对象
     * 包含以下信息：
     *   <ul>
