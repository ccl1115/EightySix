...
public class ConversationDao extends AbstractDao<Conversation, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property UnreadCount = new Property(12, Long.class, "unreadCount", false, "UNREAD_COUNT");
    ...
    public Conversation readEntity(Cursor cursor, int offset) {
        Conversation entity = new Conversation( //
            ...
            cursor.isNull(offset + 12) ? null : cursor.getLong(offset + 12), // unreadCount
    ...
    public void readEntity(Cursor cursor, Conversation entity, int offset) {
        ...
        entity.setUnreadCount(cursor.isNull(offset + 12) ? null : cursor.getLong(offset + 12));
