...
public class ConversationDao extends AbstractDao<Conversation, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property OfflineDuration = new Property(18, Long.class, "offlineDuration", false, "OFFLINE_DURATION");
        public final static Property Online = new Property(19, Boolean.class, "online", false, "ONLINE");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'CONVERSATION' (" + //
                ...
                "'OFFLINE_DURATION' INTEGER," + // 18: offlineDuration
                "'ONLINE' INTEGER);"); // 19: online
        // Add Indexes
    ...
    protected void bindValues(SQLiteStatement stmt, Conversation entity) {
        ...
        Long offlineDuration = entity.getOfflineDuration();
        if (offlineDuration != null) {
            stmt.bindLong(19, offlineDuration);
        }
 
        Boolean online = entity.getOnline();
        if (online != null) {
            stmt.bindLong(20, online ? 1l: 0l);
        }
    }
    ...
    public Conversation readEntity(Cursor cursor, int offset) {
        Conversation entity = new Conversation( //
            ...
            cursor.isNull(offset + 18) ? null : cursor.getLong(offset + 18), // offlineDuration
            cursor.isNull(offset + 19) ? null : cursor.getShort(offset + 19) != 0 // online
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Conversation entity, int offset) {
        ...
        entity.setOfflineDuration(cursor.isNull(offset + 18) ? null : cursor.getLong(offset + 18));
        entity.setOnline(cursor.isNull(offset + 19) ? null : cursor.getShort(offset + 19) != 0);
     }
